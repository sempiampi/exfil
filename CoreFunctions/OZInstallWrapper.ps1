...
$url1 = "https://codeberg.org/sempiampi/mavericks/raw/branch/main/ZeroTierStuff/ZTInstall.ps1"
$url2 = "https://codeberg.org/sempiampi/mavericks/raw/branch/main/OpenSSHStuff/OpenSSHInstallFromExe.ps1"
